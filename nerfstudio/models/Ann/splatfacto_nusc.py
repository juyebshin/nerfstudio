...
@dataclass
class SplatfactoNuscModelConfig(ModelConfig):
    """Splatfacto Model Config, nerfstudio's implementation of Gaussian Splatting"""

    _target: Type = field(default_factory=lambda: SplatfactoNuscModel)
...
class SplatfactoNuscModel(Model):
    ...
    config: SplatfactoNuscModelConfig
